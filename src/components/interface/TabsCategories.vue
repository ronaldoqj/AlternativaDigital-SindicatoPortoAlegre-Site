...
<template>
  <div class="section__default component__tabs--categories">
    <div class="tabs__categories q-mt-sm">
      <div class="container__tabs--categories">
...
<style lang="scss">
  .component__tabs--categories
  {
    .tabs__categories
    {
      display: block;

      .container__tabs--categories
      {
