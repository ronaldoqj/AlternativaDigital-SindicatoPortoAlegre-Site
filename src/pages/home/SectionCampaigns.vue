...
//   newData.push({ id: 2, image: 'assets/image/apresentation/home/campaigns/002_energia_bancaria.jpg', link: 'https://www.instagram.com/p/CyJ2CABMe6s/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA==' })
  ...
  <div class="section__default">
    ...
    <div class="section__services--carousel">
      ...
      <!-- <q-carousel-slide v-for="(arrayItem, key) in (state.carousel.carouselData as Array<ICarouselItem>[])" :key="key" :name="key" class="carousel--slide column no-wrap">
        <div class="row fit justify-center q-gutter-sm no-wrap">
        ...
        <q-carousel-slide :name="1" class="carousel--slide column no-wrap">
          <div class="row fit q-col-gutter-sm">
            <div class="col-xs-12 col-md-4 container-content"><q-img :ratio="1" class="rounded-borders content-item" src="/assets/image/apresentation/home/campaigns/001_saude_mental.jpg" @click="clickLink('https://www.instagram.com/p/CyN69NXv-pu/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA==')" /></div>
            <div class="col-xs-12 col-md-4 container-content"><q-img :ratio="1" class="rounded-borders content-item" src="/assets/image/apresentation/home/campaigns/002_energia_bancaria.jpg" @click="clickLink('https://www.instagram.com/p/CyJ2CABMe6s/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA==')" /></div>
            <div class="col-xs-12 col-md-4 container-content"><q-img :ratio="1" class="rounded-borders content-item" src="/assets/image/apresentation/home/campaigns/003_outubro_rosa.jpg" @click="clickLink('https://www.instagram.com/p/Cx2-NzfObt_/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA==')" /></div>
          </div>
        </q-carousel-slide>
        <q-carousel-slide :name="2" class="carousel--slide column no-wrap">
          <div class="row fit q-col-gutter-sm">
            <div class="col-xs-12 col-md-4 container-content"><q-img :ratio="1" class="rounded-borders content-item" src="/assets/image/apresentation/home/campaigns/004_doacao_sangue.jpg" @click="clickLink('https://www.instagram.com/p/CxYOebMuB_E/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA==')" /></div>
            <div class="col-xs-12 col-md-4 container-content"><q-img :ratio="1" class="rounded-borders content-item" src="/assets/image/apresentation/home/campaigns/005_basta.jpg" @click="clickLink('https://www.instagram.com/p/CyOL-YCOEop/?utm_source=ig_web_copy_link')" /></div>
            <div class="col-xs-12 col-md-4 container-content"><q-img :ratio="1" class="rounded-borders content-item" src="/assets/image/apresentation/home/campaigns/006_banrisul.jpg" @click="clickLink('https://www.instagram.com/p/CxFtywQtiWZ/?utm_source=ig_web_copy_link&igshid=MzRlODBiNWFlZA==')" /></div>
          </div>
        </q-carousel-slide>
