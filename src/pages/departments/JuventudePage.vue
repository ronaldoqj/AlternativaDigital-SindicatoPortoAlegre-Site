...
const setListLegalMembers = () => {
  ...
  state.legalMembers.items.listProp.push({ title: 'Rachel', surname: 'de Araujo Weber', subtitle: 'Juventude e Gênero', description: 'Caixa Econômica Federal', image: `${baseURL}temporary/images/quem-somos/directorship/juventude-e-genero_-_raquel.png` })
  state.legalMembers.items.listProp.push({ title: 'Gean Francisco', surname: 'Farias Espíndula', subtitle: 'Juventude e Gênero', description: 'Caixa Econômica Federal', image: `${baseURL}temporary/images/quem-somos/directorship/juventude-e-genero_-_gean.png` })
}
