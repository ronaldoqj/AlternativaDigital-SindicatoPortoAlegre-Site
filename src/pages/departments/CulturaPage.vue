...
const setListLegalMembers = () => {
  state.legalMembers.items.listProp.push({ title: 'Ana Lúcia', surname: 'Soares Guimaraens', subtitle: 'Cultura e Sustentabilidade', description: 'Banrisul', image: `${baseURL}temporary/images/people/diretoria_feminino.jpg` })
